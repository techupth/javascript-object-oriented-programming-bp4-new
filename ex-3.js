...
class PostList{
    ...
    sharePost(postId){
        return console.log(`You've shared post "${this.posts[postId - 1].title}" to your friend.`)
    }
}
class Post {
...
const wasin = new User(1, "Wasin", "wasin@gmail.com");
const postList = new PostList();
const firstPost = new Post(1, "++post", "This is post ");
const firstComment = new Comment(1, "comment", wasin);
